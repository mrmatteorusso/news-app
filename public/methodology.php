...
<head>
    ...
    <title>Ranking Method · Personal Briefing</title>
    <script>
        try {
...
<body>
    ...
    <main class="shell shell--status">
        <section class="status-hero">
            <div>
                <p class="hero__kicker">Transparent by design · <?= e($ranking['version']) ?></p>
                <h1>Ranking method</h1>
                <p>Stage 4 is deterministic: the same stored article metadata and the same versioned rules produce the same ranking. Qwen is not involved yet.</p>
            </div>
    ...
    <footer class="footer"><span>Personal Briefing · <?= e($ranking['version']) ?></span><a href="/">← Return to briefing</a></footer>
</body>
</html>
